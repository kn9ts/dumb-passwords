...
// const isOneOfThem = require('../lib').isOneOfThem;
// const check = require('../lib').check;
// const rateOfUsage = require('../lib').rateOfUsage;
